...
```dataview
list from "Code/AutoHotKey" AND -#Type/Readme
```
...
2. Clone my `jimbrig/Scripts` GitHub Repo: <https://github.com/jimbrig/Scripts>
3. Enter the cloned directory
4. Copy/link/create shortcut pointing [[Master AHK Script|Master.ahk]] -> `%APPDATA%\Microsoft\Windows\Start Menu\Programs\Startup` (`shell:startup`)

- [setup-ahk.ps1]()

```powershell
If (!(where.exe autohotkey)) { sudo cinst -y autohotkey.install }
gh repo clone jimbrig/Scripts
cd Scripts\AutoHotKey

# Copy Method:
Copy-Item Master.ahk '$env:APPDATA\Microsoft\Windows\Start Menu\Programs\Startup'
...
-   📂 **C:\Users\jimbr\Dev\scripts\AutoHotKey**
    -   📂 **Custom**
        -   📄 [Custom-Text-Expanders.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/Custom/Custom-Text-Expanders.ahk "Custom/Custom-Text-Expanders.ahk")
        -   📄 [Toggle-Hidden-Files-and-Folders.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/Custom/Toggle-Hidden-Files-and-Folders.ahk "Custom/Toggle-Hidden-Files-and-Folders.ahk")
    -   📂 **Global-Shortcuts**
        -   📄 [Keeper-Global-Shortcut.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/Global-Shortcuts/Keeper-Global-Shortcut.ahk "Global-Shortcuts/Keeper-Global-Shortcut.ahk")
        -   📄 [Obsidian-Global-Shortcut.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/Global-Shortcuts/Obsidian-Global-Shortcut.ahk "Global-Shortcuts/Obsidian-Global-Shortcut.ahk")
        -   📄 [Todoist-Global-Shortcut.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/Global-Shortcuts/Todoist-Global-Shortcut.ahk "Global-Shortcuts/Todoist-Global-Shortcut.ahk")
    -   📂 **HotKeyHelp**
        -   📄 [HotKey Help - Dialog.txt](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/HotKeyHelp/HotKey%20Help%20-%20Dialog.txt "HotKeyHelp/HotKey%20Help%20-%20Dialog.txt")
        -   📄 [HotkeyHelp.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/HotKeyHelp/HotkeyHelp.ahk "HotKeyHelp/HotkeyHelp.ahk")
        -   📄 [HotkeyHelp.ini](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/HotKeyHelp/HotkeyHelp.ini "HotKeyHelp/HotkeyHelp.ini")
    -   📄 [Master.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/Master.ahk "Master.ahk")

_Deprecated_

-   📂 **WinClip**
    
    -   📄 [WinClip.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/WinClip/WinClip.ahk "WinClip/WinClip.ahk")
    -   📄 [WinClipAPI.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/WinClip/WinClipAPI.ahk "WinClip/WinClipAPI.ahk")
    -   📄 [test.ahk](https://file+.vscode-resource.vscode-webview.net/c%3A/Users/jbriggs010/Dev/jimbrig/scripts/AutoHotKey/WinClip/test.ahk "WinClip/test.ahk")
